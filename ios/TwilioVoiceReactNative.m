...
- (void)initializePushRegistry {
    [[AppEventLogger shared] log:@"initializePushRegistry" type:LogTypeInfo];
    self.twilioVoicePushRegistry = [TwilioVoicePushRegistry new];
    [self.twilioVoicePushRegistry updatePushRegistry];
}

- (void)subscribeToNotifications {
    [[AppEventLogger shared] log:@"subscribeToNotifications" type:LogTypeInfo];
...
- (void)handlePushRegistryNotification:(NSNotification *)notification {
    [[AppEventLogger shared] log:@"handlePushRegistryNotification" type:LogTypeInfo];
    ...
    [[AppEventLogger shared] log:[NSString stringWithFormat:@"handlePushRegistryNotification - %@", type]
                            type:LogTypeInfo];
...
- (void)handleRouteChange:(NSNotification *)notification {
    [[AppEventLogger shared] log:@"handleRouteChange" type:LogTypeInfo];
...
- (void)initializeAudioDeviceList {
    [[AppEventLogger shared] log:@"initializeAudioDeviceList" type:LogTypeInfo];
...
- (BOOL)selectAudioDevice:(NSString *)uuid {
    [[AppEventLogger shared] log:@"selectAudioDevice" type:LogTypeInfo];
...
- (NSDictionary *)callInfo:(TVOCall *)call {
    [[AppEventLogger shared] log:@"callInfo" type:LogTypeInfo];
...
- (NSDictionary *)callInviteInfo:(TVOCallInvite *)callInvite {
    [[AppEventLogger shared] log:@"callInviteInfo" type:LogTypeInfo];
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    if (self.deviceTokenData) {
        [[AppEventLogger shared] log:@"voice_getDeviceToken" type:LogTypeInfo];
        ...
        [[AppEventLogger shared] log:@"voice_getDeviceToken - else" type:LogTypeInfo];
        resolve(@"");
    }
}
...
RCT_EXPORT_METHOD(voice_initializePushRegistry:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    [[AppEventLogger shared] log:@"voice_initializePushRegistry" type:LogTypeInfo];
...
RCT_EXPORT_METHOD(voice_setCallKitConfiguration:(NSDictionary *)configuration
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    [[AppEventLogger shared] log:@"voice_setCallKitConfiguration" type:LogTypeInfo];
...
RCT_EXPORT_METHOD(voice_register:(NSString *)accessToken
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    [[AppEventLogger shared] log:@"voice_register" type:LogTypeInfo];
...
- (void)asyncPushRegistryInitialization:(dispatch_time_t)timeout
    ...
    [[AppEventLogger shared] log:@"asyncPushRegistryInitialization" type:LogTypeInfo];
...
RCT_EXPORT_METHOD(voice_unregister:(NSString *)accessToken
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    [[AppEventLogger shared] log:@"voice_unregister" type:LogTypeInfo];
...
RCT_EXPORT_METHOD(voice_connect_ios:(NSString *)accessToken
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    [[AppEventLogger shared] log:@"voice_connect_ios" type:LogTypeInfo];
...
RCT_EXPORT_METHOD(call_disconnect:(NSString *)uuid
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    [[AppEventLogger shared] log:@"call_disconnect" type:LogTypeInfo];
...
RCT_EXPORT_METHOD(call_getState:(NSString *)uuid
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    [[AppEventLogger shared] log:@"call_getState" type:LogTypeInfo];
...
RCT_EXPORT_METHOD(call_getSid:(NSString *)uuid
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    [[AppEventLogger shared] log:@"call_getSid" type:LogTypeInfo];
...
RCT_EXPORT_METHOD(call_getFrom:(NSString *)uuid
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    [[AppEventLogger shared] log:@"call_getFrom" type:LogTypeInfo];
...
RCT_EXPORT_METHOD(call_getTo:(NSString *)uuid
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    [[AppEventLogger shared] log:@"call_getTo" type:LogTypeInfo];
...
RCT_EXPORT_METHOD(call_getStats:(NSString *)uuid
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    [[AppEventLogger shared] log:@"call_getStats" type:LogTypeInfo];
...
RCT_EXPORT_METHOD(call_sendMessage:(NSString *)uuid
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    [[AppEventLogger shared] log:@"call_sendMessage" type:LogTypeInfo];
...
RCT_EXPORT_METHOD(callInvite_accept:(NSString *)callInviteUuid
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    [[AppEventLogger shared] log:@"callInvite_accept" type:LogTypeInfo];
...
RCT_EXPORT_METHOD(callInvite_reject:(NSString *)callInviteUuid
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    [[AppEventLogger shared] log:@"callInvite_reject" type:LogTypeInfo];
