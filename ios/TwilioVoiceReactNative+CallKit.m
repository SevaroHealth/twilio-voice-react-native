...
- (void)initializeCallKit {
    [[AppEventLogger shared] log:@"initializeCallKit" type:LogTypeInfo];
    [self initializeCallKitWithConfiguration:nil];
}

- (void)initializeCallKitWithConfiguration:(NSDictionary *)configuration {
    [[AppEventLogger shared] log:@"initializeCallKitWithConfiguration" type:LogTypeInfo];
...
- (void)reportNewIncomingCall:(TVOCallInvite *)callInvite {
    [[AppEventLogger shared] log:@"reportNewIncomingCall" type:LogTypeInfo];
    ...
    [self.callKitProvider reportNewIncomingCallWithUUID:callInvite.uuid update:callUpdate completion:^(NSError *error) {
        if (!error) {
            ...
            [[AppEventLogger shared] log:@"Incoming call successfully reported." type:LogTypeInfo];
        } else {
            [[AppEventLogger shared] log:[NSString stringWithFormat:@"Failed to report incoming call: - %@", error]
                                    type:LogTypeInfo];
...
- (void)answerCallInvite:(NSUUID *)uuid
    ...
    [[AppEventLogger shared] log:@"answerCallInvite." type:LogTypeInfo];
...
- (void)endCallWithUuid:(NSUUID *)uuid {
    [[AppEventLogger shared] log:@"endCallWithUuid." type:LogTypeInfo];
...
- (void)makeCallWithAccessToken:(NSString *)accessToken
    ...
    [[AppEventLogger shared] log:@"makeCallWithAccessToken." type:LogTypeInfo];
...
- (void)performVoiceCallWithUUID:(NSUUID *)uuid
                      ...
                      completion:(void(^)(BOOL success))completionHandler {
    [[AppEventLogger shared] log:@"performVoiceCallWithUUID." type:LogTypeInfo];
...
- (void)updateCall:(NSString *)uuid callerHandle:(NSString *)handle {
    [[AppEventLogger shared] log:@"updateCall." type:LogTypeInfo];
...
- (void)providerDidReset:(CXProvider *)provider {
    [[AppEventLogger shared] log:@"providerDidReset." type:LogTypeInfo];
    [TwilioVoiceReactNative twilioAudioDevice].enabled = NO;
}

- (void)providerDidBegin:(CXProvider *)provider {
    [[AppEventLogger shared] log:@"providerDidBegin." type:LogTypeInfo];
...
- (void)provider:(CXProvider *)provider performEndCallAction:(CXEndCallAction *)action {
    [[AppEventLogger shared] log:@"provider - performEndCallAction." type:LogTypeInfo];
...
- (void)provider:(CXProvider *)provider performStartCallAction:(CXStartCallAction *)action {
    [[AppEventLogger shared] log:@"provider - performStartCallAction." type:LogTypeInfo];
...
- (void)provider:(CXProvider *)provider performAnswerCallAction:(CXAnswerCallAction *)action {
    [[AppEventLogger shared] log:@"provider - performAnswerCallAction." type:LogTypeInfo];
...
- (void)provider:(CXProvider *)provider performSetHeldCallAction:(CXSetHeldCallAction *)action {
    [[AppEventLogger shared] log:@"provider - performSetHeldCallAction." type:LogTypeInfo];
...
- (void)provider:(CXProvider *)provider performSetMutedCallAction:(CXSetMutedCallAction *)action {
    [[AppEventLogger shared] log:@"provider - performSetMutedCallAction." type:LogTypeInfo];
...
- (void)provider:(CXProvider *)provider performPlayDTMFCallAction:(CXPlayDTMFCallAction *)action {
    [[AppEventLogger shared] log:@"provider - performPlayDTMFCallAction." type:LogTypeInfo];
...
- (void)callDidStartRinging:(TVOCall *)call {
    [[AppEventLogger shared] log:@"callDidStartRinging" type:LogTypeInfo];
...
- (void)callDidConnect:(TVOCall *)call {
    [[AppEventLogger shared] log:@"callDidConnect" type:LogTypeInfo];
...
- (void)call:(TVOCall *)call didDisconnectWithError:(NSError *)error {
    [[AppEventLogger shared] log:@"didDisconnectWithError" type:LogTypeInfo];
...
- (void)call:(TVOCall *)call didFailToConnectWithError:(NSError *)error {
    [[AppEventLogger shared] log:[NSString stringWithFormat:@"didFailToConnectWithError - %@", error]
                            type:LogTypeInfo];
...
- (void)callDisconnected:(TVOCall *)call {
    [[AppEventLogger shared] log:@"callDisconnected" type:LogTypeInfo];
...
- (void)call:(TVOCall *)call isReconnectingWithError:(NSError *)error {
    [[AppEventLogger shared] log:[NSString stringWithFormat:@"isReconnectingWithError - %@", error]
                            type:LogTypeInfo];
...
- (void)callDidReconnect:(TVOCall *)call {
    [[AppEventLogger shared] log:@"callDidReconnect" type:LogTypeInfo];
...
previousWarnings:(NSSet<NSNumber *> *)previousWarnings {
    [[AppEventLogger shared] log:@"didReceiveQualityWarnings" type:LogTypeInfo];
